...
export class AppComponent implements OnInit, OnDestroy {
  readonly Math = Math;
  navItems: NavItem[] = [
    { key: 'overview', label: '儀錶板', icon: '◎' },
    { key: 'trends', label: '趨勢圖', icon: '⌁' },
    { key: 'channels', label: '報表資料', icon: '▦' },
    { key: 'alarms', label: '警報中心', icon: '△' },
    { key: 'permissions', label: '帳號權限', icon: '♙' },
    { key: 'account', label: '測試', icon: '⚗' },
